  ...
  return (
    ...
    <>
      ...
      <header className="md:hidden flex items-center justify-between w-full bg-white dark:bg-gray-800 border-b border-slate-100 dark:border-gray-700 px-6 py-4 sticky top-0 z-40 shadow-sm transition-colors duration-200">
        ...
        {/* Container for dark mode toggle and mobile menu button */}
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-slate-50 dark:bg-gray-700 text-slate-600 dark:text-gray-300 hover:bg-slate-100 dark:hover:bg-gray-600 focus:outline-none transition-colors"
      ...
      >
        ...
        <aside
          ...
          className={`absolute top-0 left-0 bottom-0 w-72 bg-white dark:bg-gray-800 px-6 py-8 flex flex-col justify-between shadow-2xl transition-transform duration-300 transform ${
        ...
        >
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/" onClick={() => setIsOpen(false)} className="flex items-center gap-2 font-bold text-xl tracking-tight text-slate-800 dark:text-white">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-50 dark:bg-gray-700 text-slate-600 dark:text-gray-300 hover:bg-slate-100 dark:hover:bg-gray-600"
              >
          ...
          <div className="border-t border-slate-100 dark:border-gray-700 pt-4 text-xs text-slate-400 dark:text-gray-500">
      ...
      <aside className="hidden md:flex flex-col justify-between w-64 min-h-screen bg-white dark:bg-gray-800 border-r border-slate-100 dark:border-gray-700 sticky top-0 px-6 py-8 shrink-0 shadow-sm z-20 transition-colors duration-200">
        {/* Upper layout area grouping logo branding and main page links list */}
        <div className="flex flex-col gap-8">
          {/* Main logo branding Link layout routing back to '/' */}
          <Link to="/" className="flex items-center gap-2 font-bold text-xl tracking-tight text-slate-800 dark:text-white px-2">
        ...
        <div className="border-t border-slate-100 dark:border-gray-700 pt-6 px-2 text-xs text-slate-400 dark:text-gray-500">
