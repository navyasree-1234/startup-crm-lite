...
function EmptyAnalyticsState() {
  return (
    <div className="flex flex-col items-center justify-center bg-white border border-slate-200 rounded-2xl p-10 py-16 text-center shadow-sm max-w-lg mx-auto my-10 animate-in fade-in zoom-in-95 duration-200">
      {/* Icon Area */}
      <div className="flex items-center justify-center w-16 h-16 rounded-full bg-slate-50 border border-slate-200 text-slate-400 mb-6">
